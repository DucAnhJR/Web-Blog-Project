                        ...
                        <c:forEach items="${list}" var="o">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="deleteFromAll?pid=${o.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                            ...
                            <div class="form-group">
                                ...
                                <select name="category" class="form-select" aria-label="Default select example">
                                    <c:forEach items="${listT}" var="o">
                                        <option value="${o.topID}">${o.topName}</option>
                                    </c:forEach>
                                </select>
                            </div>
